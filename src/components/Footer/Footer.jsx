...
<footer className="font-sans tracking-wide bg-black px-8 py-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10">
        <div>
          <a href='javascript:void(0)' id="color">Sprout & Shop</a>
        ...
        <div>
          <h4 className="text-white font-semibold text-lg relative max-sm:cursor-pointer">Services <svg
            ...
            <pathName
              ...
              data-name="16" data-original="#000000"></pathName>
          </svg>
          </h4>

          <ul className="mt-6 space-y-5">
            <li>
              <a href='javascript:void(0)' className='hover:text-white text-gray-300 text-sm'>Plants</a>
            </li>
            <li>
              <a href='javascript:void(0)' className='hover:text-white text-gray-300 text-sm'>Types</a>
            </li>
            <li>
              <a href='javascript:void(0)' className='hover:text-white text-gray-300 text-sm'>Support</a>
            </li>
            <li>
              <a href='javascript:void(0)' className='hover:text-white text-gray-300 text-sm'>Clients</a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-5 mt-6 max-sm:hidden">
            ...
            <li>
              <a href='javascrNameipt:void(0)' className='hover:text-white text-gray-300 text-sm'>Marketing Glossar</a>
            </li>
            <li>
